...
public class RegisterStageThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_stage_three);
        ...
        ivDriverFront.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(RegisterStageThree.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
...
//And finally ask for the permission
        ...
        switch (requestCode) {
            case STORAGE_PERMISSION_CODE: {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(RegisterStageThree.this,"Request Denied",Toast.LENGTH_LONG).show();
        ...
        if (requestCode == RESULT_INSURANCE_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            try {
                ...
                if (insuranceImage != null) {
                    ...
                    insuranceImageCompressed = new Compressor.Builder(RegisterStageThree.this)
                            .setMaxWidth(800)
                            .setMaxHeight(600)
                            .setQuality(100)
            ...
            try {
                ...
                if (driverBack != null) {
                    ...
                    driverbackcompress = new Compressor.Builder(RegisterStageThree.this)
                            .setMaxWidth(800)
                            .setMaxHeight(600)
                            .setQuality(100)
                            .setCompressFormat(Bitmap.CompressFormat.PNG)
            ...
            try {
                ...
                if (policefront != null) {
                    ...
                    policefrontcompress = new Compressor.Builder(RegisterStageThree.this)
                            .setMaxWidth(800)
                            .setMaxHeight(600)
                            .setQuality(100)
                            .setCompressFormat(Bitmap.CompressFormat.PNG)
            ...
            try {
                ...
                if (policeback != null) {
                    ...
                    policebackcompress = new Compressor.Builder(RegisterStageThree.this)
                            .setMaxWidth(800)
                            .setMaxHeight(600)
                            .setQuality(100)
                            .setCompressFormat(Bitmap.CompressFormat.PNG)
            ...
            try {
                ...
                if (workfront != null) {
                    ...
                    workfrontcompress = new Compressor.Builder(RegisterStageThree.this)
                            .setMaxWidth(800)
                            .setMaxHeight(600)
                            .setQuality(100)
                            .setCompressFormat(Bitmap.CompressFormat.PNG)
            ...
            try {
                ...
                if (workback != null) {
                    ...
                    workbackcompress = new Compressor.Builder(RegisterStageThree.this)
                            .setMaxWidth(800)
                            .setMaxHeight(600)
                            .setQuality(100)
                            .setCompressFormat(Bitmap.CompressFormat.PNG)
    ...
    public void webServiceFunction1() {
        ...
        try {
            ...
            RequestBody stageid = RequestBody.create(MediaType.parse("text/plain"),"3");
            RequestBody driverid = RequestBody.create(MediaType.parse("text/plain"),driverID);
            MultipartBody.Part driverFront1 = MultipartBody.Part.createFormData("vehicle_insurance_front", insuranceImageCompressed.getName(), requestImage);
            MultipartBody.Part driverBack1 = MultipartBody.Part.createFormData("vehicle_insurance_back", driverbackcompress.getName(), requestImage2);
            MultipartBody.Part policeFront1 = MultipartBody.Part.createFormData("vehicle_registration_front", policefrontcompress.getName(), requestImage3);

            MultipartBody.Part policeFront2 = MultipartBody.Part.createFormData("vehicle_registration_back", policebackcompress.getName(), requestImage4);

            MultipartBody.Part workFront1 = MultipartBody.Part.createFormData("safety_certificate_front", workfrontcompress.getName(), requestImage5);

            MultipartBody.Part workBack1 = MultipartBody.Part.createFormData("safety_certificate_back", workbackcompress.getName(), requestImage6);
            hitRegisterTwo(driverid,stageid,driverFront1,driverBack1,workFront1,workBack1,policeFront1,policeFront2);

        } catch (Exception e) {
            e.printStackTrace();

            Toast.makeText(RegisterStageThree.this, "Something went wrong.please try again later", Toast.LENGTH_LONG);
        }
    ...
    private void hitRegisterTwo(RequestBody driverid,RequestBody stageid, MultipartBody.Part driverFront1,MultipartBody.Part driverBack1,MultipartBody.Part workFront1,
        ...
        Call<RegisterStagesTwo> call = apiInterface.registerThree(driverid,stageid,driverFront1,driverBack1,workFront1,workBack1,policeFront1,policeFront2);
            ...
            public void onResponse(Call<RegisterStagesTwo> call, retrofit2.Response<RegisterStagesTwo> response) {
                ...
                if (response.isSuccessful()) {
                    if(response.body().getCode().equals(100))
                    {
                        ...
                        Toast.makeText(RegisterStageThree.this,"Upload Documents Successfully",Toast.LENGTH_SHORT).show();
                        // Utilss.makeSnackBar(RegisterActivity.this, background, "Register Successfully");
                       /* Intent i = new Intent(RegisterStageThree.this,LoginActivity.class);
                        startActivity(i);
*/
                        Intent i = new Intent(RegisterStageThree.this,RegisterStageFour.class);
                        startActivity(i);
                    }
                    else {
...
//                        String text = response.body().getText();
                        ...
                        Toast.makeText(RegisterStageThree.this,"Email already Exists",Toast.LENGTH_SHORT).show();
//
